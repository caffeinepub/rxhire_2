...
export const idlService = IDL.Service({
  ...
  adminDeleteEmployer: IDL.Func([IDL.Text, IDL.Nat], [OkErrNull], []),
  adminDeletePharmacist: IDL.Func([IDL.Text, IDL.Nat], [OkErrNull], []),
  adminDeleteJob: IDL.Func([IDL.Text, IDL.Nat], [OkErrNull], []),
